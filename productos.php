        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="img/Entradas/Ensalada de Quinoa y Aguacate.jpg" class="card-img-top img-fluid" alt="Imagen de ensalada" style="height: 300px;">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="img/Entradas/Rollitos de Alga Nori con Salmon.jpg" class="card-img-top img-fluid" alt="Imagen de rollitos de alga nori con salmón" style="height: 300px;">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="img/Entradas/Sopa de Calabaza Asada.jpg" class="card-img-top img-fluid" alt="Imagen de Sopa de Calabaza " style="height: 300px;">
                    <div class="card-body d-flex flex-column">
...
<section>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="img/Platos Principales/Pasta de Calabacin con Pesto de Albahaca.webp" class="card-img-top img-fluid" alt="Imagen de Pasta de Calabacín con Pesto de Albahaca" style="height: 300px;">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="img/Platos Principales/Pollo a la Barbacoa con Batata Asada.jpg" class="card-img-top img-fluid" alt="Imagen de Pollo a la Barbacoa con Batata Asada " style="height: 300px;">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="img/Platos Principales/Salmon a la Parrilla con Salsa de Limon.jpg" class="card-img-top img-fluid" alt="Imagen de Salmon a la Parrilla con Salsa de Limon" style="height: 300px;">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="img/Platos Principales/Tofu Salteado con Vegetales.jpg" class="card-img-top img-fluid" alt="Imagen de Tofu Salteado con Vegetales " style="height: 400px;">
                    <div class="card-body d-flex flex-column">
...
<div class="container">
        <div class="row">
            <div class="col-md-12 mb-4">
                ...
                <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="img/Guarniciones/Berenjenas al Horno.webp" class="card-img-top img-fluid" alt="Imagen de Berenjenas al Horno  " style="height: 300px;">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="img/Guarniciones/Pure de Coliflor y Brocoli.jpg" class="card-img-top img-fluid" alt="Imagen de Pure de Coliflor y Brocoli  " style="height: 300px;">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="img/Guarniciones/Ensalada de Lentejas y Kale.jpg" class="card-img-top img-fluid" alt="Imagen de Ensalada de Lentejas y Kale  " style="height: 300px;">
                    <div class="card-body d-flex flex-column">
...
<div class="container">
        <div class="row">
            <div class="col-md-12 mb-4">
                ...
                <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="img/Postres/Chia Pudding con Frutos Rojos.jpg" class="card-img-top img-fluid" alt="Imagen de Chia Pudding con Frutos Rojos" style="height: 300px;">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="img/Postres/Tarta de Manzana sin Azúcar.jpg" class="card-img-top img-fluid" alt="Imagen de Tarta de Manzana sin Azúcar" style="height: 300px;">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="img/Postres/Yogur Griego Natural con Frutas.webp" class="card-img-top img-fluid" alt="Imagen de Yogur Griego Natural con Frutas" style="height: 300px;">
                    <div class="card-body d-flex flex-column">
...
<div class="container">
        <div class="row">
            <div class="col-md-12 mb-4">
                ...
                <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="img/Bebidas/Agua Infundida.jpg" class="card-img-top img-fluid" alt="Imagen de Agua Infundida" style="height: 300px;">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="img/Bebidas/Agua.jpg" class="card-img-top img-fluid" alt="Imagen de Agua " style="height: 300px;">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="img/Bebidas/Te Verde Frio con Menta y Limon.jpg" class="card-img-top img-fluid" alt="Imagen de Te Verde Frio con Menta y Limon" style="height: 300px;">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="img/Bebidas/Batido de Proteínas con Espinacas y Plátano.jpg" class="card-img-top img-fluid" alt="Imagen de Batido de Proteínas con Espinacas y Plátano " style="height: 300px;">
                    <div class="card-body d-flex flex-column">
