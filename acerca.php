...
<main class="container">
    ...
    <section class="row">
        ...
        clientes y sus necesidades asociadas a su estilo de vida.
        Calidad: El esfuerzo por mantener los estándares de calidad en todos los ingredientes es
        fundamental dentro de los valores de la empresa conseguir que cada comida que sea servida
        sea de la más alta calidad.
        Servicio al Cliente: Brindar un servicio excepcional es prioridad dentro de los valores de la
        compañía para asegurar que cada interacción sea positiva.
        Responsabilidad Social: Promover la salud refleja el compromiso por ser miembros
